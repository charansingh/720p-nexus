...
public class CameraStartUp extends InstrumentationTestCase {
    ...
    private static final String CAMERA_PACKAGE_NAME = "com.camera.camera";
    private static final String CAMERA_ACTIVITY_NAME = "com.camera.camera.Camera";
    private static final String VIDEORECORDER_ACTIVITY_NAME = "com.camera.camera.VideoCamera";
