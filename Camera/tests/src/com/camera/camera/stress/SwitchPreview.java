...
package com.camera.camera.stress;

import com.camera.camera.VideoCamera;
 ...
 *    -e class com.camera.camera.stress.SwitchPreview \
 *    -w com.camera.camera.tests/com.camera.camera.CameraStressTestRunner
 *
 */
public class SwitchPreview extends ActivityInstrumentationTestCase2 <VideoCamera>{
    ...
    public SwitchPreview() {
        super("com.camera.camera", VideoCamera.class);
    }
    ...
    public void testSwitchMode() {
        ...
        try{
            ...
            for (int i=0; i< TOTAL_NUMBER_OF_SWITCHING; i++) {
                ...
                intent.setClassName("com.camera.camera",
                        "com.camera.camera.VideoCamera");
                getActivity().startActivity(intent);
                Thread.sleep(WAIT_FOR_PREVIEW);
                intent.setClassName("com.camera.camera",
                "com.camera.camera.Camera");
                getActivity().startActivity(intent);
                mOut.write(" ," + i);
                mOut.flush();
            }
